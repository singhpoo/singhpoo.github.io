...
Full Stack Software Engineer with 7+ years of industry experience leading projects to deliver solutions for empowering end-to-end user experience. Proficient in cross-functional collaboration across engineering, design, and product teams to streamline processes, elevate customer satisfaction, and improve operational efficiency through data-driven analysis. Strong mentoring and training abilities.
...
- **Backend:** Node.js, NoSQL/SQL
- **Testing:** Puppeteer, Playwright, React Testing Lib, Jest, JUnit
- **DevOps:** Kubernetes, CI/CD
- **Cloud & Data:** Azure, AWS, LLM applications
- **AI/ML:** Prompt Engineering, Retrieval Augmented Generation, LangChain
